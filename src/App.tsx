...
import { Mail, Phone, MapPin, Camera, Film, Scissors, Palette, ArrowRight } from 'lucide-react';
...
function App() {
  ...
  // Automatically sets the default filter to the first category in your data file
  const defaultCategory = Object.keys(categoryLabels).length > 0 ? Object.keys(categoryLabels)[0] : 'Branded';
  ...
  return (
    <>
      ...
      <div className="min-h-dvh transition-colors duration-500 bg-transparent">
        ...
        {/* Skills Section - UPDATED TO VIDEO FOCUS */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { 
                  ...
                  description: "High-fidelity video production utilizing modern stabilized rigs and strategic lighting to engineer premium visual assets.", 
                  color: "from-orange-500 to-red-500",
                  category: "Video"
                },
                { 
                  icon: Scissors, 
                  title: "Kinetic Editing", 
                  description: "Hook-driven, high-retention post-production. Specialized in fast-paced cuts, sound design, and cross-platform formatting.", 
                ...
                { 
                  icon: Palette, 
                  title: "Color Grading", 
                  description: "Premium narrative color pipelines that establish mood, ensure brand consistency, and elevate the perceived value of your product.", 
                ...
                { 
                  ...
                  description: "High-resolution retouched stills captured simultaneously during video production to provide a cohesive visual suite.", 
        ...
        <section id="portfolio" className="py-20 relative">
          ...
          >
            ...
            <motion.div 
              className="flex w-full max-w-md mx-auto p-1.5 rounded-2xl mb-8 md:mb-12"
              style={glassCardStyle(isDarkMode)}
              variants={sectionVariants}
            >
              {Object.entries(categoryLabels).map(([key, label]) => (
                <button
                  ...
                  className={`relative flex-1 py-2.5 rounded-xl font-semibold text-sm md:text-base transition-colors duration-300 ${
                    activeFilter === key 
                ...
                {filteredProjects.map((project, index) => (
                  ...
                  >
                   <img
                    ...
                    alt={project.title}
                    // ADDED: scale-[1.35] pushes the baked-in black bars out of the frame.
                    // CHANGED: group-hover:scale-[1.45] keeps the hover animation smooth.
                    className="w-full h-full object-cover scale-[1.35] transition-all duration-300 group-hover:scale-[1.45]"
                    loading="lazy"
                    />
        ...
        {/* Footer */}
        <footer 
          className="py-6 border-t text-center transition-all duration-500 mt-20"
          style={{
            background: isDarkMode 
              ? 'rgba(18, 18, 18, 0.7)' 
